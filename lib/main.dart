...
class CameraPageState extends State<CameraPage> with WidgetsBindingObserver {
    ...
    try {
      ...
      if (image != null) {
        ...
        if (reimaginedImage != null) {
          ...
          _displayProcessedPhoto(reimaginedImage);
        }
      }
    } finally {
      setState(() {
  ...
  Future<void> _displayProcessedPhoto(String processedImagePath) async {
  ...
  // Function to show the preferences dialog
                  ...
                  Positioned(
                    ...
                    child: Row(
                      ...
                      children: [
                        // About dialog button
                        InkWell(
                          onTap: _processing ? null : _showAboutDialog,
                          onTapCancel: () {
                            setState(() {
                        ...
                        InkWell(
                          onTap: _processing ? null : _showPreferencesDialog,
                          onTapCancel: () {
                            setState(() {
...
class PreviewPage extends StatefulWidget {
  ...
  const PreviewPage({super.key, this.imagePath});
